    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        while(true){
            ...
            if(option==1){
                ...
                assignment2.updatePhone(acc_no,Phone_no,pin_no);
                ...
                assignment2.insert(acc_no,acc_name, pin_no,pan_no,balance,address,acc_type, bank_name, phone_no);
